...
Это руководство по интеграции с системой Bereke Bank, предназначенное для **регистрации заказов**, **проверки их статуса**, а также выполнения **возвратов**, **отмен** и **аннулирований платежей** через эквайринговую платформу банка.
